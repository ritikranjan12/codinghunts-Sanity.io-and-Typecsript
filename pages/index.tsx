      ...
      <div className="flex min-h-screen flex-col md:px-2  max-w-7xl mx-auto">
        ...
        <div className='justify-center items-center shadow-lg shadow-red-800' style={{ backgroundColor: `${bcolor}` }}>
          ...
          <div className='flex justify-center items-center'>
            <h2 className='text-2xl font-bold underline  md:text-3xl lg:text-4xl my-3 text-white '>Hi👋, I am  <span className='text-blue-400'><Link href='https://portfolio.coderhunts.com/'>Ritik Ranjan!(Resume)</Link> </span> </h2>
          </div>
